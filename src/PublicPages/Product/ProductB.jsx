          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10 w-full">
            <div className="flex-1 text-left">
              ...
              <motion.div variants={fadeInUp} transition={{ delay: 0.2 }}>
                <Title
                  level={1}
                  className="text-white! text-5xl! md:text-8xl! font-extrabold! mb-8! tracking-tighter leading-[0.9]!"
                >
                  Fluid Motion, <br />
                  On-Device AI.
                </Title>
              ...
              <motion.div variants={fadeInUp} transition={{ delay: 0.4 }}>
                <Paragraph className="text-blue-100 text-xl max-w-xl mb-12 leading-relaxed">
                  We craft mobile experiences that don't just work—they feel
                  alive. Leveraging Swift, Kotlin, and React Native to build the
                  future of mobile commerce and utility.
                </Paragraph>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} transition={{ delay: 0.6 }}>
                <Button
                  size="large"
                  className="h-16 px-12 text-lg font-bold rounded-2xl bg-white text-blue-600 border-none shadow-xl hover:scale-105 transition-all"
                  onClick={() =>
                    handleConsult(
                      "Consultation for Enterprise Mobile Development.",
                    )
                  }
                >
            ...
            <Col xs={24} md={10} className="flex justify-center relative">
              ...
              >
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{ delay: 1.2, ...bouncySpring }}
                  className="text-center"
                >
                  <FireOutlined className="text-blue-500 text-7xl mb-4 animate-bounce" />
                  <Text className="text-slate-400 block text-xs tracking-widest uppercase font-bold">
                    Vault Mobile OS
                  </Text>
                </motion.div>
            ...
            <Row gutter={[24, 24]}>
              {[
                ...
                },
                {
                  ...
                  title: "Hybrid Apps",
                  tags: ["React Native", "Expo", "JSI"],
                },
                {
                  icon: <ThunderboltOutlined />,
                  title: "Connectivity",
                  tags: ["gRPC", "MQTT", "Offline Sync"],
                },
              ].map((item, i) => (
        ...
        <section className="py-24 px-6 text-center bg-white">
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              >
                "The gesture controls and offline-first logic Vault implemented
                changed our entire delivery ecosystem. It's the most stable app
                we've ever launched."
              </Title>
              ...
              <div className="mt-12">
                <Button
                  ...
                  size="large"
                  shape="round"
                  className="h-16 px-12 bg-blue-600 border-none font-bold hover:scale-105 transition-all shadow-xl shadow-blue-200"
                  onClick={() =>
                    handleConsult(
                      "Consultation for Enterprise Mobile Development.",
                    )
