      ...
      <section className="relative h-[60vh] flex items-center justify-center bg-slate-900 text-white overflow-hidden">
        ...
        >
          ...
          <Paragraph className="text-slate-300 text-lg max-w-2xl mx-auto">
            Our Asset Management System streamlines the lifecycle of IT and
            physical assets, ensuring transparency, security, and peak
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <Paragraph>
                    Monitor every laptop, server, and software license from
                    procurement to disposal. Get instant notifications on
                    warranty expirations and maintenance schedules.
                  </Paragraph>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <Paragraph>
                    Seamlessly assign assets to employees based on department
                    and role, reducing manual paperwork and human error in IT
                    helpdesk operations.
                  </Paragraph>
                </div>
              </div>
                    ...
                    items={[
                      {
                        children: (
                          <span className="text-slate-300">
                            2023: System Concept & Architecture
                          </span>
                        ),
                        color: "blue",
                      },
                      {
                        children: (
                          <span className="text-slate-300">
                            2024: Beta Launch for IT Departments
                          </span>
                        ),
                        color: "blue",
                      },
                      {
                        children: (
                          <span className="text-white font-semibold">
                            2026: Enterprise-wide Integration
                          </span>
                        ),
                        color: "green",
                      },
      ...
      <section className="bg-white border-t py-16 text-center">
        ...
        >
          ...
          <Paragraph className="text-slate-500 mb-8">
            Join hundreds of departments managing their assets with 100%
            accuracy and zero stress.
          </Paragraph>
          <button
            ...
            onClick={() =>
              handleConsult("Consultation for Asset Management System.")
            }
          >
            Get Started Today
          </button>
