...
const handleAction = async (requestId, actionStatus) => {
    ...
    try {
        ...
        const res = await axios.patch(
            `https://it-backend-6bvo.onrender.com/api/Assets/updateAssetRequest/${requestId}`,
  ...
  },
  {
    ...
    return (
        ...
        // </div>
        <div>
            <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">Test Asset Request Panel</h1>
        </div>
    );
};
