      ...
      {showForm &&
        createPortal(
          <div className="fixed inset-0 z-10000 flex justify-end">
            ...
            />
            <div
              className={`relative w-full max-w-lg h-full bg-white shadow-2xl flex flex-col transform transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${isAnimating ? "translate-x-0" : "translate-x-full"}`}
            >
              <div className="p-6 border-b flex justify-between items-center">
                ...
                >
                  <PlusOutlined className="rotate-45 text-xl" />
                </button>
              </div>
              ...
              <div className="flex-1 p-8 overflow-y-auto">
                ...
                >
                  <Form.Item
                    name="subject"
                    label="Issue Subject"
                    rules={[{ required: true, message: "What is the issue?" }]}
                  >
                    <Input
      ...
      <Option value="High">High</Option>
              ...
              <div className="p-6 border-t bg-slate-50 flex justify-end gap-3">
                ...
                <Button
                  ...
                  form="ticket-form"
                  htmlType="submit"
                  className="bg-blue-600 h-10 px-8 rounded-xl font-bold"
                >
                  Submit Ticket
                </Button>
              </div>
